...
<br>
<br>
I am a PhD candidate in the Biomedical Engineering program at Oregon Health & Science University School of Medicine, advised by [Prof. Peter Jacobs](https://www.ohsu.edu/people/peter-g-jacobs-phd ) at [Artificial Intelligence for Medical Systems (AIMS) Lab](https://www.ohsu.edu/school-of-medicine/jacobs-lab). My research is to enable small language models as specialized agents in a multi-agentic framework for supporting day-to-day recommendations for individuals living with type 1 diabetes. Currently, I have built a small language model agent that estimates distributions for carbohydrate content and their uncertainty from diverse chat-based meal queries and leverages the person's past insulin intakes and glucose levels to recommend a meal bolus that minimizes hypo- and hyperglycemic risks.
...
<br>
<br>I have enjoyed working at or collaborating with the following institutions:
<br>
<br>
